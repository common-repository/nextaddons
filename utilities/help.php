...
class Help{
    ...
    public static function old_version(){
        $version = get_option('__nextaddons_version');
    ...
    public static function set_version(){
		if(!get_option('__nextaddons_version')){
			set_option('__nextaddons_version', \NextAddons\Plugin::_version());
		}
	}
	...
	public static function render( $content ){
		if (stripos($content, "nextaddons-has-lisence") !== false) {
			return null;
		}
	...
	public static function _get_check(){
		if ( ! did_action( 'nextaddonsPro/loaded' ) ) {
			return false;
		}else if( did_action( 'nextaddonsPro/loaded' ) ){
			if( get_option('__validate_author_naddons__', 'inactive') != 'active'){
				return false;
			}
		}
		return true;
