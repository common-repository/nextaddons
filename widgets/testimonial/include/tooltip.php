    ...
    <?php }?> 
        ...
        if( is_array($nextaddons_testimonial_items) && !empty($nextaddons_testimonial_items) ){
            foreach($nextaddons_testimonial_items as $k=>$v):
                ...
                <?php }?> 
                <div class="nxadd-smart-testimonial nxtestimonial-content <?php if($nextaddons_testimonial_popup_enable == 'yes'){?>nx-popup-data<?php }?>">
                    <div class="nxadd-author-card before-bar">
