        ...
        if( is_array($nextaddons_team_items) && !empty($nextaddons_team_items) ){
            foreach($nextaddons_team_items as $k=>$v):
                ...
                <?php }?>  
                	...
                	<div class="nxadd-team-member-profile nx-text-center nxaddons-round-image <?php if($nextaddons_team_popup_enable == 'yes'){?>nx-popup-data<?php }?>">
