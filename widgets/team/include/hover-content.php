    ...
    <?php }?> 
        ...
        if( is_array($nextaddons_team_items) && !empty($nextaddons_team_items) ){
            foreach($nextaddons_team_items as $k=>$v):
                ...
                <div class="nxadd-team-member-profile <?php echo esc_attr($class_content);?> <?php if($nextaddons_team_popup_enable == 'yes'){?>nx-popup-data<?php }?>">
                    <?php
                    ...
                    <div class="nxadd-hide-content">
                        <div class="nxadd-team-member-content">
                            ...
                            <p class="member-des">
                            <?php echo wp_trim_words( $overview, $nextaddons_team_designation_limit, '...' );?> 
                            </p>
                            <?php endif;?> 
                        </div>
                        <?php if( $nextaddons_team_social_enable == 'yes'){?>
                        <ul class="nxadd-social nxaddon-social-colored nxaddon-iconTranslateY">
                        <?php if( !empty($fb) ){?>
