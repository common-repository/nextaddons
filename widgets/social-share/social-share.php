...
use \NextAddons\Widgets\NextConfig_Social_Share as NX_Config;
...
class NextAddons_Social_Share extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		if ( NX_Config::instance()->_is_nextsocial_activated() && is_object($this->login) ) {
			...
			$this->login_style = \themeDevSocial\Apps\Settings::$share_style;
			...
			$getDisplay = get_option( \themeDevSocial\Apps\Settings::$sharing_display_key );
...
*/
    ...
    protected function _register_controls() {
	   ...
	   $this->start_controls_section(
			'_section_nextsocial',
			[
				'label' => NX_Config::instance()->_is_nextsocial_activated() ? __( 'Social Share', 'next-addons' ) : __( 'Missing Notice',
					'next-addons' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => '<a href="http://support.themedev.net/docs-category/social-share/" target="_blank" rel="noopener">Click to view doc of Social Share</a>',
			]
		);
		...
		$this->add_group_control(
			...
			'selector'	 => '{{WRAPPER}} .nextaddons-socialshare .next-social-sharing ._next_style_ul > li._next_style_li > a .login-count',
		...
		$this->add_group_control(
			...
			'selector'	 => '{{WRAPPER}} .nextaddons-socialshare .next-social-sharing ._next_style_ul > li._next_style_li > a .login-text',
		...
		$this->add_group_control(
			...
			'selector'	 => '{{WRAPPER}} .nextaddons-socialshare .next-social-sharing ._next_style_ul > li._next_style_li > a .next-icon > i:before',
    ...
    protected function render() {
		...
		extract($settings);
		$elementorID = 'nxaddons-socialshare-'.$this->get_id();
		...
		echo '<div class="nextaddons-socialshare " id="'.$elementorID.'">';
