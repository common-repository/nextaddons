            ...
            while ( $post_query->have_posts() ) : 
                ...
                <?php }?>  
                    ...
                    <div class="woocommerce">
						<ul class="products">
							<li class="products-item <?php echo esc_attr($classs);?>">
								<div class="nxadd-wc-products-image">
                                     <div class="nxadd-wc-product-popup popup-right ">
                                        <a class="product-popup-link" href="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'full' ); ?>">
                                            <i class="nx-icon nx-icon-eye"></i>
                                        </a>
									...
									<?php if($nextaddons_wooshop_featured_enable == 'yes'){?>    
                                        ...
                                        <?php if( $nextaddons_wooshop_addtocart_enable == 'yes'):
                                            ...
                                            ?>  
                                        <div class="nxadd-wc-add-to-card vertical-align-bottom">
