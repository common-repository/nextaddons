...
<div class="themedev-gallery-slider-wrapper <?php echo esc_attr($nextaddons_custom_class);?>" >
    <div class="slidercontent <?php echo esc_attr($nextaddons_layout_type);?>">
        ...
        <div class="slider-wrapper <?php echo esc_attr($classs);?>">
            ...
            if( is_array($nextaddons_slider_photos_items) && !empty($nextaddons_slider_photos_items) ){
        ...
        <div class="nxadd-gallery-slider-sync-thumb video-bottom-content nx-image-feed"  id="<?php echo esc_attr($elementorID);?>-click">
            <?php if( is_array( $data ) && !empty( $data ) ):
                ...
                ?>
            <div class="nx-item nx-item-click <?php if($k == 0){?> active <?php }?>" nx-click-item-index="<?php echo $k;?>">  
                <div class="nxadd-single-thumb">
                <a class="nxadd-nav-item" >
                    <?php
                    if($id != '' || $id != 0){
                        echo wp_get_attachment_image( $id, 'thumbnail' , '', ['class' => 'nx-full-width']);
                    }else{
                    ?>
